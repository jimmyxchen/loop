export default function DemandCardInput() {
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      <h3 className="text-sm font-medium text-gray-900 mb-3">New Demand Card</h3>
      <div className="space-y-3">
        <div>
          <label className="block text-xs text-gray-500 mb-1">Requirement (≤100 chars)</label>
          <textarea
            ...
            rows={2}
            placeholder="e.g., Make a tomato clock with dark mode toggle, illustrations should be cute"
          />
        </div>
        <div>
          <label className="block text-xs text-gray-500 mb-1">Style Reference</label>
          <input
            className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900"
            placeholder="e.g., Minimalist, playful illustration style"
          />
        </div>
